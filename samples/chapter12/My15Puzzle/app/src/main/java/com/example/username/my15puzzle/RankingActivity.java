...
public class RankingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 30; i++) {
            int result_time =
                    pref.getInt(RESULT_TIME_STR + String.valueOf(i), 9999999);
        ...
        ScoreAdapter adapter =
                new ScoreAdapter(getApplicationContext(), R.layout.score_cell,
                        time,mList);
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent goToMain =
                        new Intent(RankingActivity.this, MainActivity.class);
    ...
    public class ScoreAdapter extends ArrayAdapter<Integer> {
        ...
        public ScoreAdapter(Context context, int resource, int time,
